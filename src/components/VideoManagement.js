...
                        <tr>
                            <th>Title</th>
                            {/* ✅ Leader Video ke liye Channel Name header shamil karein */}
...
                                    <td data-label="Title">{video.title}</td>
                                    {/* ✅ Leader Video ke liye Channel Name data dikhayein */}
                                    {videoType === 'leaders' && (
...
                        ) : (
                            <tr>
                                {/* ColSpan को totalColSpan के बराबर सेट करें */}
                                <td colSpan={totalColSpan} style={{ textAlign: 'center', padding: '20px' }}>
...
    
    // --- NAYA STATE: View Management (Unchanged) ---
...
    // --- Render Function for Main Hub (Unchanged) ---
    const renderMainView = () => (
        <>
            {/* --- Batch Import Card (Unchanged) --- */}
