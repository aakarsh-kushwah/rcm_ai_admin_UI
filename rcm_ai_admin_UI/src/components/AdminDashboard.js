...
const menuItems = [
    ...
    },
    {
        ...
        desc: "Unified sync engine for RCM products and Cloudinary media.",
            ...
            <div className="dashboard-alert-container critical-alert">
                <div className="alert-track">
                    ...
                    <span className="alert-msg">
                        ...
                        <strong className="scary-text">अंतिम चेतावनी:</strong> {' '}
                        यदि यह पैनल किसी गलत व्यक्ति के हाथ लगा, तो वह <strong>पूरी एप्लीकेशन खाली (Delete)</strong> कर सकता है।
                    </span>
                    ...
                    <span className="alert-msg">
                        अगर पासवर्ड शेयर करने से ऐसा हुआ, तो <strong>रिकवरी असंभव (Impossible)</strong> {' '}
                        होगी और <strong>डेवलपमेंट टीम की कोई जिम्मेदारी नहीं होगी।</strong>
                    </span>
